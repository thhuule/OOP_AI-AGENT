...
This folder is the entry point for team planning and historical coordination.

## Read first

- [Current status](status/PROJECT_STATUS.md): active goal, blockers, and latest verified gate.
- [`weekly-plans/`](weekly-plans/): choose the newest applicable plan as the working plan.
